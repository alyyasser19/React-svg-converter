...
interface UploadUpIconProps extends React.SVGProps<SVGSVGElement> {
	size?: string | number;
	color?: string;
...
const UploadUpIcon: React.FC<UploadUpIconProps> = ({
	size = 24,
	color = "currentColor",
	strokeWidth = 2,
	absoluteStrokeWidth,
